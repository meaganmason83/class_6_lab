...
var allStores = [];
 ...
 function createStore() {
   ...
   this.cupsIntoPounds = cupsIntoPounds;
   this.cupsPlusPounds = cupsPlusPounds;
   this.poundsPerHour = cupsPerHour;
   this.poundsPerDay = poundsPerDay;
   this.totalBeansPerHour = totalBeansPerHour;
   this.totalBeansPerDay = totalBeansPerDay;
   this.dailyToGoPackages = dailyToGoPackages;
   this.employeesPerHour = employeesPerHour;
   this.employeesPerDay = employeesPerDay;
   this.stringsForDOM = stringsForDOM;
